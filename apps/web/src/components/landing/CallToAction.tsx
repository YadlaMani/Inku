...
const CallToAction = () => {
  return (
    <section className="container px-4 py-16 mx-auto mb-16">
      <div className="max-w-4xl mx-auto text-center bg-white/50 backdrop-blur-sm rounded-3xl p-12 relative overflow-hidden border border-black/10 hover:shadow-xl transition-all">
        <div className="relative space-y-6">
          ...
          <h2 className="text-4xl font-bold">
            ...
            <div className="mt-2 h-1 w-24 mx-auto bg-black/10 rounded-full" />
          </h2>
