...
const Testimonials = () => {
  return (
    <section className="container px-4 py-16 mx-auto bg-accent/20 rounded-3xl my-16">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Testimonial 1 */}
          <Card className="bg-white border border-black/10 hover:shadow-lg transition-shadow">
            <CardContent className="p-6 space-y-4">
              <QuoteIcon className="h-6 w-6 text-black/20" />
              ...
              <div className="flex items-center gap-3 pt-4">
                <div className="w-10 h-10 rounded-full bg-black/10 flex items-center justify-center text-xs font-bold">
                  S
                </div>
                <div>
